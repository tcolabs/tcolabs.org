...
if(!function_exists('qode_startit_tabs_typography_styles')){
	function qode_startit_tabs_typography_styles(){
		...
		if(qode_startit_is_font_option_valid($font_family)){
			$tabs_tipography_array['font-family'] = qode_startit_is_font_option_valid($font_family);
		}
        ...
        if($letter_spacing !== '') {
            $tabs_tipography_array['letter-spacing'] = qode_startit_filter_px($letter_spacing).'px';
        }
        ...
        echo qode_startit_dynamic_css($selector, $tabs_tipography_array);
	}
