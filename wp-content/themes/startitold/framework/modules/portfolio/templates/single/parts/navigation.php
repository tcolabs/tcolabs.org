    ...
    <div class="qodef-portfolio-single-nav">
        <?php if(get_previous_post() !== '') : ?>
            <div class="qodef-portfolio-prev">
                <?php if($nav_same_category) {
                    previous_post_link('%link', '<span class="fa fa-chevron-left"></span>', true, '', 'portfolio_category');
                } else {
        ...
        <?php if(get_next_post() !== '') : ?>
            <div class="qodef-portfolio-next">
                <?php if($nav_same_category) {
                    next_post_link('%link', '<span class="fa fa-chevron-right"></span>', true, '', 'portfolio_category');
                } else {
