...
if(!function_exists('qode_startit_register_required_plugins')) {
    /**
     * Registers Visual Composer, Layer Slider, Select Core, Select Twitter Feed  as required plugins. Hooks to tgmpa_register hook
     */
    function qode_startit_register_required_plugins() {
        $plugins = array(
            ...
            array(
                'name'               => 'LayerSlider WP',
                'slug'               => 'LayerSlider',
                'source'             => get_template_directory().'/includes/plugins/layersliderwp-5.6.2.installable.zip',
                'version'            => '',
                'required'           => true,
                'force_activation'   => false,
                'force_deactivation' => false,
